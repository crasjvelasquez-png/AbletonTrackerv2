...
class DashboardProjectTaskTests(unittest.TestCase):
    ...
    def test_project_task_validation(self):
        ...
        bad_date = dashboard.create_project_task("Planner Song", "Record vocals", "normal", "2026-02-30")
        bad_date_format = dashboard.create_project_task("Planner Song", "Record vocals", "normal", "06/10/2026")
        ...
        self.assertEqual(bad_date["error"], "Task due date must be a valid YYYY-MM-DD date.")
